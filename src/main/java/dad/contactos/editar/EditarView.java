...
public class EditarView extends BorderPane {
	...
	public EditarView() {
		...
		guardarButton.setMaxWidth(Double.MAX_VALUE); // ancho máximo = infinito

		cancelarButton = new Button("Cancelar");
		cancelarButton.setCancelButton(true);
		cancelarButton.setMaxWidth(Double.MAX_VALUE); // ancho máximo = infinito

		VBox botonesPane = new VBox(5, guardarButton, cancelarButton);
